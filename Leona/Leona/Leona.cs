...
namespace Leona
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("WhenAA", "When to use Q").SetValue(new StringList(new[] { "Before AA", "On AA", "After AA" }, 0)));
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                Drawing.DrawCircle(Player.ServerPosition, E.Range, Color.Yellow);
            }
